 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["exports","require","vs/base/common/functional","vs/base/common/platform","vs/base/common/uri","vs/base/browser/browser","vs/base/common/strings","vs/base/common/lifecycle","vs/base/common/errors","vs/base/common/winjs.base","vs/base/common/event","vs/base/common/linkedList","vs/base/node/ps","vs/platform/node/product","vs/css!vs/code/electron-browser/processExplorer/media/processExplorer","vs/css!vs/code/electron-browser/processExplorer/processExplorerMain","child_process","path","vs/code/electron-browser/processExplorer/processExplorerMain","electron","os","vs/nls!vs/code/electron-browser/processExplorer/processExplorerMain"];
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[7/*vs/base/common/lifecycle*/], __M([1/*require*/,0/*exports*/,2/*vs/base/common/functional*/]), function (require, exports, functional_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[11/*vs/base/common/linkedList*/], __M([1/*require*/,0/*exports*/]), function (require, exports) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[4/*vs/base/common/uri*/], __M([1/*require*/,0/*exports*/,3/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the Source EULA. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[8/*vs/base/common/errors*/], __M([1/*require*/,0/*exports*/,9/*vs/base/common/winjs.base*/]), function (require, exports, winjs_base_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the Source EULA. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[10/*vs/base/common/event*/], __M([1/*require*/,0/*exports*/,8/*vs/base/common/errors*/,2/*vs/base/common/functional*/,7/*vs/base/common/lifecycle*/,11/*vs/base/common/linkedList*/,9/*vs/base/common/winjs.base*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, winjs_base_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the Source EULA. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
...
define(__m[5/*vs/base/browser/browser*/], __M([1/*require*/,0/*exports*/,10/*vs/base/common/event*/]), function (require, exports, event_1) {
    /*---------------------------------------------------------------------------------------------
     *  Copyright (c) Microsoft Corporation. All rights reserved.
     *  Licensed under the Source EULA. See License.txt in the project root for license information.
     *--------------------------------------------------------------------------------------------*/
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[12/*vs/base/node/ps*/], __M([1/*require*/,0/*exports*/,16/*child_process*/,4/*vs/base/common/uri*/]), function (require, exports, child_process_1, uri_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[14/*vs/css!vs/code/electron-browser/processExplorer/media/processExplorer*/], __M([15/*vs/css!vs/code/electron-browser/processExplorer/processExplorerMain*/]), {});

/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[13/*vs/platform/node/product*/], __M([1/*require*/,0/*exports*/,17/*path*/,4/*vs/base/common/uri*/]), function (require, exports, path, uri_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the Source EULA. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[18/*vs/code/electron-browser/processExplorer/processExplorerMain*/], __M([1/*require*/,0/*exports*/,12/*vs/base/node/ps*/,19/*electron*/,6/*vs/base/common/strings*/,20/*os*/,13/*vs/platform/node/product*/,21/*vs/nls!vs/code/electron-browser/processExplorer/processExplorerMain*/,5/*vs/base/browser/browser*/,3/*vs/base/common/platform*/,14/*vs/css!vs/code/electron-browser/processExplorer/media/processExplorer*/]), function (require, exports, ps_1, electron_1, strings_1, os_1, product_1, nls_1, browser, platform) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var processList;
    ...
    function showContextMenu(e) {
        ...
        if (pid && typeof pid === 'number') {
            menu.append(new electron_1.remote.MenuItem({
    ...
    function startup(data) {
        ...
        electron_1.ipcRenderer.on('windowsInfoResponse', function (event, windows) {
        ...
        setInterval(function () {
            ...
            ps_1.listProcesses(electron_1.remote.process.pid).then(function (processes) {
