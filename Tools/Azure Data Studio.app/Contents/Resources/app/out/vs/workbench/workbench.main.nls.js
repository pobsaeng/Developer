...
define("vs/workbench/workbench.main.nls", {
	...
	"sql/base/browser/ui/modal/modal": [
		"Information",
		"Warning",
		"Error",
		"Show Details",
	...
	"sql/parts/accountManagement/autoOAuthDialog/autoOAuthDialog": [
		"Copy & Open",
		"Cancel",
		"User code",
		"Website"
	...
	"sql/parts/accountManagement/common/accountManagement.contribution": [
	...
	"sql/parts/dashboard/common/dashboardHelper": [
	...
	"sql/parts/dashboard/common/dashboardTab.contribution": [
	...
	"sql/parts/dashboard/containers/dashboardContainer.contribution": [
	...
	"sql/parts/dashboard/containers/dashboardControlHostContainer.contribution": [
		"The controlhost that will be displayed in this tab."
	],
	"sql/parts/dashboard/containers/dashboardErrorContainer.component": [
		"The \"{0}\" section has invalid content. Please contact extension owner."
	],
	"sql/parts/dashboard/containers/dashboardGridContainer.contribution": [
	...
	"sql/parts/dashboard/containers/dashboardModelViewContainer.contribution": [
		"The model-backed view that will be displayed in this tab."
	],
	"sql/parts/dashboard/containers/dashboardNavSection.contribution": [
	...
	"sql/parts/dashboard/containers/dashboardWebviewContainer.contribution": [
		"The webview that will be displayed in this tab."
	],
	"sql/parts/dashboard/containers/dashboardWidgetContainer.contribution": [
	...
	"sql/parts/dashboard/pages/dashboardPageContribution": [
		"Condition which must be true to show this item",
	...
	"sql/parts/dashboard/widgets/insights/views/charts/chartInsight.component": [
	...
	"sql/parts/dashboard/widgets/insights/views/charts/types/barChart.contribution": [
	...
	"sql/parts/dashboard/widgets/insights/views/tableInsight.contribution": [
	...
	"sql/parts/dataExplorer/common/dataExplorer.contribution": [
		"Data Explorer",
		"View",
	...
	"sql/parts/dataExplorer/common/dataExplorerExtensionPoint": [
	...
	"sql/parts/dataExplorer/objectExplorer/connectionViewlet/connectionViewletPanel": [
		"Search server names"
	],
	"sql/parts/dataExplorer/viewlet/dataExplorerViewlet": [
		"Servers"
	],
	...
	"sql/parts/jobManagement/agent/agentView.component": [
		"Jobs",
		"Alerts",
		"Proxies",
		"Operators"
	],
	"sql/parts/jobManagement/views/alertsView.component": [
		"Name",
		"Last Occurrence",
		"Enabled",
	...
	"sql/parts/jobManagement/views/jobHistory.component": [
		"Step ID",
		"Step Name",
		"Message"
	],
	"sql/parts/jobManagement/views/jobsView.component": [
		"Name",
		"Last Run",
		"Next Run",
		"Enabled",
	...
	"sql/parts/jobManagement/views/operatorsView.component": [
		"Name",
		"Email Address",
		"Enabled"
	],
	"sql/parts/jobManagement/views/proxiesView.component": [
		"New Proxy",
		"Refresh",
		"Account Name",
		"Credential Name",
	...
	"sql/parts/modelComponents/componentBase": [
		"The index is invalid."
	],
	"sql/parts/modelComponents/inputbox.component": [
		"Invalid value"
	],
	"sql/parts/modelComponents/loadingComponent.component": [
		"Loading"
	],
	"sql/parts/modelComponents/loadingSpinner.component": [
		"Loading"
	],
	"sql/parts/modelComponents/queryTextEditor": [
		"modelview code editor for view model."
	],
	"sql/parts/modelComponents/viewBase": [
		"Could not find component for type {0}"
	],
	"sql/parts/notebook/cellToggleMoreActions": [
		"Delete",
		"Insert Code before",
		"Insert Code after",
		"Insert Markdown before",
		"Insert Markdown after",
		"Clear output"
	],
	"sql/parts/notebook/cellViews/codeActions": [
		"Please select active cell and try again",
		"Run cell",
		"Cancel execution",
		"Error on last run. Click to run again"
	],
	"sql/parts/notebook/cellViews/placeholderCell.component": [
		"Click on",
		"+ Code",
		"or",
		"+ Text",
	...
	"sql/parts/notebook/models/cell": [
	...
	"sql/parts/notebook/models/clientSession": [
		"Server did not start for unknown reason",
		"Kernel {0} was not found. The default kernel will be used instead."
	],
	"sql/parts/notebook/models/notebookContexts": [
		"Select connection",
		"localhost",
		"Add new connection"
	],
	"sql/parts/notebook/models/notebookModel": [
		"Failed to delete cell.",
		"Failed to change kernel: {0}",
		"Changing context failed: {0}",
		"Loading kernel info failed: {0}",
		"Could not start session: {0}",
		"A client session error occurred when closing the notebook: {0}",
		"An error occurred when closing the notebook: {0}"
	],
	"sql/parts/notebook/notebook.component": [
		...
		"Save",
		"Notebook",
		"Failed to save notebook: {0}",
		"cell with URI {0} was not found in this model"
	],
	"sql/parts/notebook/notebookActions": [
		"Loading kernels...",
		"Kernel: ",
		"Attach to: ",
		"Loading contexts...",
	...
	"sql/parts/notebook/notebookInput": [
	...
	"sql/parts/notebook/notebookUtils": [
		"... Creating {0}"
	],
	"sql/parts/objectExplorer/common/objectExplorerService": [
		"Failed to create Object Explorer session",
		"Mulitiple errors:",
		"The given tree node no longer exists"
	],
	"sql/parts/objectExplorer/common/registeredServer.contribution": [
		"View",
		"Database Connections",
		"data source connections",
		"data source groups",
	...
	"sql/parts/objectExplorer/serverGroupDialog/serverGroup.contribution": [
		"Server Group color palette used in the Object Explorer viewlet.",
		"Auto-expand Server Groups in the Object Explorer viewlet."
	],
	"sql/parts/objectExplorer/serverGroupDialog/serverGroupDialog": [
		"Server Groups",
		"OK",
		"Cancel",
		"Server group name",
	...
	"sql/parts/objectExplorer/serverGroupDialog/serverGroupViewModel": [
		"Add server group",
		"Edit server group"
	],
	"sql/parts/objectExplorer/viewlet/connectionTreeAction": [
		"Refresh",
		"Disconnect",
		"New Connection",
		"New Server Group",
	...
	"sql/parts/profiler/dialog/profilerFilterDialog": [
		"Clear All",
		"Apply",
		"OK",
		"Cancel",
	...
	"sql/parts/profiler/editor/controller/profilerTableEditor": [
		"Events (Filtered): {0}/{1}",
		"Events: {0}"
	],
	...
	"sql/parts/query/common/flavorStatus": [
		"Choose SQL Language",
	...
	"sql/parts/query/common/queryInput": [
		"disconnected"
	],
	"sql/parts/query/common/queryResultsInput": [
		"Extension"
	],
	"sql/parts/query/common/rowCountStatus": [
		"Row Count",
		"{0} rows"
	],
	"sql/parts/query/common/timeElapsedStatus": [
		"Time Elapsed"
	],
	"sql/parts/query/editor/actions": [
		"Save As CSV",
		"Save As JSON",
		"Save As Excel",
		"Save As XML",
	...
	"sql/parts/query/editor/charting/actions": [
		"Create Insight",
	...
	"sql/parts/query/editor/charting/chartOptions": [
		"Data Direction",
		"Vertical",
		"Horizontal",
	...
	"sql/parts/query/editor/charting/chartTab": [
		"Chart"
	],
	"sql/parts/query/editor/charting/insights/graphInsight": [
		"Series {0}",
		"Series {0}"
	],
	"sql/parts/query/editor/queryResultsView": [
		"Results",
		"Messages",
		"Results"
	],
	...
	"sql/parts/queryPlan/queryPlan": [
		"Query Plan"
	],
	"sql/parts/queryPlan/topOperations": [
		"Operation",
		"Object",
		"Est Cost",
		"Est Subtree Cost",
	...
	"sql/workbench/electron-browser/enablePreviewFeatures": [
		"Would you like to enable preview features?",
		"Yes",
		"No",
		"No, don't show again"
	],
	...
	"sql/workbench/parts/connection/electron-browser/connectionViewlet": [
		"Search server names"
	],
	...
	"sql/workbench/services/notebook/common/sqlSessionManager": [
		"SQL",
		"SQL kernel error",
	...
	"vs/workbench/browser/parts/editor/editorStatus": [
		...
		"Screen Reader Optimized",
		"Are you using a screen reader to operate Azure Data Studio?",
		"Yes",
		"No",
		"Azure Data Studio is now optimized for usage with a screen reader.",
	...
	"vs/workbench/parts/extensions/electron-browser/extensionsActions": [
		...
		"Successfully installed the extension. Reload to enable it.",
		"Reload Now",
		"Your extension policy does not allow downloading extensions. Please change your extension policy and try again.",
		"Reinstall Extension...",
	...
	"vs/workbench/parts/extensions/node/extensionsWorkbenchService": [
		...
		"Also disable the dependencies of the extensions?",
		"Also disable the dependencies of the extension '{0}'?",
		"Yes",
		"Cancel",
		"No",
	...
	"vs/workbench/parts/localizations/electron-browser/localizationsActions": [
		...
		"Defines Azure Data Studio's display language.",
		"See {0} for a list of supported languages.",
		"Changing the value requires restarting Azure Data Studio.",
	...
	"vs/workbench/parts/preferences/browser/keybindingsEditor": [
		...
		"keybindings.json",
		"Keybindings",
		"Showing {0} Keybindings in precendence order",
	...
	"vs/workbench/parts/preferences/browser/settingsTree": [
		...
		"Show other matching extensions",
		"Modified",
		"Also modified in",
		"Modified in",
		"{0} {1}, Setting",
	...
	"vs/workbench/parts/preferences/browser/settingsWidgets": [
		...
		"(For settings editor preview) The foreground color for a the modified setting indicator.",
		"(For settings editor preview) The color of the selected setting row border, when the settings list does not have focus.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminal.contribution": [
		...
		"Controls whether to restore terminal sessions for the workspace automatically when launching VS Code. This is an experimental setting; it may be buggy and could change or be removed in the future.",
	...
	"vs/workbench/parts/terminal/electron-browser/terminalInstance": [
		...
		"Yes",
		"The termnial is now using the fallback renderer.",
		"No",
		"Don't Show Again",
	...
	"vs/workbench/parts/update/electron-browser/update": [
		...
		"Don't Show Again",
		"You are running the system-wide installation of {0}, while having the user-wide distribution installed as well. Make sure you're running the {0} version you expect.",
		"OK",
		"Don't Show Again",
